...
**Código:** 6098  
**Nome em Inglês:** Laboratory of Computer Systems: Compilers  
...
O conceito final será computado com base na avaliação de dois entregáveis ao longo do semestre.

**O primeiro entregável será composto por (valendo 3 pontos):**
...
- Exemplos de geração de código intermediário, a partir de programas C-

**O segundo entregável será composto por (valendo 7 pontos):**
- Relatório final (conforme template a ser disponibilizado)
- Código fonte completo do Compilador (envolvendo todos os módulos de análise de síntese)

Em ambos entregáveis, os alunos deverão fazer uma apresentação presencial para o professor.
