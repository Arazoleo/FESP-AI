...
**Código:** 8288  
**Nome em Inglês:** Information Security  
...
Princípios de segurança, privacidade e integridade da informação. Leis, normas e políticas de segurança da informação. Análise forense digital. Métodos e técnicas algorítmicas de autenticação por biometria.

## Conteúdo Programático

### Princípios de segurança, privacidade e integridade da informação
- Papeis e responsabilidades em empresas

### Leis, normas e políticas de segurança da informação
- ISOs e normas ABNT
...
### Métodos e técnicas algorítmicas de autenticação por biometria
- Conceitos de processamento de imagens aplicados a falsificação de documentos e autenticação de usuários
- Conceitos de inteligência artificial aplicados a autenticação e proteção de usuários
...
- **Semana 2:** Introdução a Análise Forense Digital
- **Semana 3:** Conceitos de Imagem Digital
- **Semana 4:** Conceitos de Aprendizado de Máquina
- **Semana 5:** Fonte de aquisição de imagens
- **Semana 6:** Conceitos de Identificação de Cópia Colagem
- **Semana 7:** Inconsistências na Aquisição
- **Semana 8:** Conceitos de Biometria e Spoofing
- **Semana 9:** Prova
- **Semana 10:** Introdução a qualidade e conceitos de segurança
- **Semana 11:** Hexagrama Parkeriano e outros conceitos de segurança
- **Semana 12:** Políticas e organização, recursos humanos e ativos
- **Semana 13:** Controle de acesso, criptografia
- **Semana 14:** Pre-avaliação de projeto
- **Semana 15:** Segurança física e operacional
- **Semana 16:** Segurança da comunicação e aquisição, manutenção de sistema
- **Semana 17:** Gestão de incidentes de segurança e conformidade
- **Semana 18:** Projeto
